...
roi = rgb2gray(img(214:295,198:244,:));
...
disp('covmat1./covmat = '); disp(covmat1./covmat);
disp('for diagonal elements: ')
disp('diag(covmat1)./diag(covmat)='); disp(diag(covmat1)./diag(covmat));
disp('for trace: ')
disp('trace(covmat1)/trace(covmat)='); disp(trace(covmat1)/trace(covmat));
...
disp('scale is 0.9');
disp('for whole matrix: ');
disp('covmat2./covmat='); disp(covmat2./covmat);
disp('for diagonal elements: ')
disp('diag(covmat2)./diag(covmat)='); disp(diag(covmat2)./diag(covmat));
disp('for trace: ');
disp('trace(covmat2)/trace(covmat)='); disp(trace(covmat2)/trace(covmat));
